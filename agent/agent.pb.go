...
const file_agent_agent_proto_rawDesc = "" +
	...
	"\x04file\x18\x01 \x01(\fR\x04file\"S\n" +
	"\x1dFetchAttestationResultRequest\x12\x1e\n" +
	"\n" +
	"tokenNonce\x18\x01 \x01(\fR\n" +
	"tokenNonce\x12\x12\n" +
	"\x04type\x18\x03 \x01(\x05R\x04type\"N\n" +
	"\x1eFetchAttestationResultResponse\x12,\n" +
	"\x11AttestationResult\x18\x01 \x01(\fR\x11AttestationResult2\xe4\x02\n" +
	"\fAgentService\x123\n" +
	...
	"\vAttestation\x12\x19.agent.AttestationRequest\x1a\x1a.agent.AttestationResponse\"\x000\x01\x12e\n" +
	"\x16FetchAttestationResult\x12$.agent.FetchAttestationResultRequest\x1a%.agent.FetchAttestationResultResponseB\tZ\a./agentb\x06proto3"

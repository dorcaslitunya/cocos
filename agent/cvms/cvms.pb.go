...
const file_agent_cvms_cvms_proto_rawDesc = "" +
	...
	"\ttimestamp\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\"\x93\x03\n" +
	...
	"\x15vTPMattestationReport\x18\x06 \x01(\v2\x19.cvms.AttestationResponseH\x00R\x15vTPMattestationReportB\t\n" +
	"\amessage\"\x8d\x02\n" +
	...
	"\ragentStateReq\x18\x04 \x01(\v2\x13.cvms.AgentStateReqH\x00R\ragentStateReqB\t\n" +
	"\amessage\"K\n" +
